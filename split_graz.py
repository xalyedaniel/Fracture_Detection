...
if __name__ == "__main__":
    ...
    img_dir = "./GRAZ_dset/yolov5/images/"
    ann_dir = "./GRAZ_dset/yolov5/labels/"
    df = pd.read_csv("./GRAZ_dset/dataset.csv")
    ...
    train_df.to_csv("./GRAZ_dset/train_data.csv", index=False)
    valid_df.to_csv("./GRAZ_dset/valid_data.csv", index=False)
    test_df.to_csv("./GRAZ_dset/test_data.csv", index=False)

    img_train_dir = "./GRAZ_dset/data/images/train/"
    img_valid_dir = "./GRAZ_dset/data/images/valid/"
    img_test_dir = "./GRAZ_dset/data/images/test/"
    ann_train_dir = "./GRAZ_dset/data/labels/train/"
    ann_valid_dir = "./GRAZ_dset/data/labels/valid/"
    ann_test_dir = "./GRAZ_dset/data/labels/test/"
